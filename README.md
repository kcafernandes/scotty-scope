...
Most people may agree that course registration is often very time consuming and unfortunately UCR is no exception. Students may find themselves switching between the course catalog, Degree Audit, Reddit, Rate My Professors, the MASSIVE course difficulty database, and other websites to research courses and instructors. They may also need to determine which quarters a course is typically offered, compare professor ratings, understand prerequisites, and estimate course difficulty. Overall, course registration is a very tedious process that shouldn't be this difficult :')
